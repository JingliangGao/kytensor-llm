...
int main(int argc, char ** argv) {
    ...
    if (is_router_server) {
        ...
        // single-process explicit load/unload (same process, no child spawn)
        ctx_http.post("/model/load",           ex_wrapper(routes.post_model_load));
        ctx_http.post("/model/unload",         ex_wrapper(routes.post_model_unload));
    }
