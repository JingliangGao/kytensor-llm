        ...
        if (!embd.empty()) {
            ...
            if (ga_n == 1) {
                ...
                if (n_past + (int) embd.size() >= n_ctx) {
                    if (llama_memory_expansion(mem, ctx, 1)) {
                        ...
                        int32_t n_discard = llama_memory_shift(mem, 0, n_past, params.n_keep);
                        if (n_discard <= 0) {
                ...
                llama_memory_shift_extend(mem, 0, &n_past, &ga_i, ga_n, ga_w);
            }
