...
本文档包含三个 DEB 包在ARM64系统上安装说明：

1. `xdl-rpp-dkms_1.0.0_all.deb`
2. `xdl-rpp-runtime_1.0.1_amd64.deb`
...
fb06192befd7e0ea097b91fec6b75305  xdl-rpp-runtime_1.0.1_amd64.deb
...
```
(正在读取数据库 ... 系统当前共安装有 259117 个文件和目录。)
准备解压 xdl-rpp-dkms_1.0.0_all.deb  ...
正在解压 xdl-rpp-dkms (1.0.0) ...
正在设置 xdl-rpp-dkms (1.0.0) ...
...
Building module:
cleaning build area...
make -j16 KERNELRELEASE=5.4.18-152-generic -C /lib/modules/5.4.18-152-generic/build M=/var/lib/dkms/rpp-dkms/2.0.16.12/build variant=vpu modules...
cleaning build area...
...
Running module version sanity check.
 ...
 - Installation
   - Installing to /lib/modules/5.4.18-152-generic/kernel/extra/
...
```
kos@kos-pc:~/Yan_debug/0729_release$ ls -ll /usr/src/rpp-dkms-*/
总用量 824
-rwxr-xr-x 1 root root   1923 7月  29 15:35 detect_platform.sh
-rw-r--r-- 1 root root    377 7月  29 15:35 dkms.conf
-rw-r--r-- 1 root root      8 7月  29 15:35 git_version.txt
drwxrwxr-x 2 root root   4096 7月  29 16:21 include
-rw-r--r-- 1 root root   2801 7月  29 15:35 Makefile
-rw-r--r-- 1 root root   2966 7月  29 15:35 platform.mk
-rw-r--r-- 1 root root   9114 7月  29 15:35 rpp_cdev.c
-rw-r--r-- 1 root root  39438 7月  29 15:35 rpp_cdev_ctrl.c
-rw-r--r-- 1 root root 113283 7月  29 15:35 rpp_dev.c
-rw-r--r-- 1 root root  36322 7月  29 15:35 rpp_dev_list.c
-rw-r--r-- 1 root root  40439 7月  29 15:35 rpp_dma.c
-rw-r--r-- 1 root root  94495 7月  29 15:35 rpp_hal_dma.c
-rw-r--r-- 1 root root  17186 7月  29 15:35 rpp_hal_pcie.c
-rw-r--r-- 1 root root  24283 7月  29 15:35 rpp_isr.c
-rw-r--r-- 1 root root  73645 7月  29 15:35 rpp_mod.c
-rw-r--r-- 1 root root   7345 7月  29 15:35 rpp_mpu.c
-rw-r--r-- 1 root root  21769 7月  29 15:35 rpp_pages.c
-rw-r--r-- 1 root root  17148 7月  29 15:35 rpp_pm.c
-rw-r--r-- 1 root root  19598 7月  29 15:35 rpp_sdev.c
-rw-r--r-- 1 root root   9319 7月  29 15:35 rpp_sdev_ctrl.c
-rw-r--r-- 1 root root  15384 7月  29 15:35 rpp_vdev.c
-rw-r--r-- 1 root root 218471 7月  29 15:35 rpp_vdev_ctrl.c
-rw-r--r-- 1 root root  15270 7月  29 15:35 rpp_ve_vmm.c
-rw-r--r-- 1 root root  10828 7月  29 15:35 rpp_xdata.c
-rw-r--r-- 1 root root     66 7月  29 15:35 version.mk
kos@kos-pc:~/Yan_debug/0729_release$ ls -ll /lib/modules/$(uname -r)/kernel/extra/
总用量 452
-rw-r--r-- 1 root root 462032 7月  29 16:21 rpp.ko
```
...
```
kos@kos-pc:~/Yan_debug/0729_release$  ls -ll /lib/firmware/rpp/
总用量 112
...
kos@kos-pc:~/Yan_debug/0729_release$ 
```
...
```bash
sudo dpkg -i xdl-rpp-runtime_1.0.1_amd64.deb
```
...
```
kos@kos-pc:~/Yan_debug/0729_release$ sudo dpkg -i xdl-rpp-runtime_1.0.1_amd64.deb 
正在选中未选择的软件包 xdl-rpp-runtime。
(正在读取数据库 ... 系统当前共安装有 259171 个文件和目录。)
准备解压 xdl-rpp-runtime_1.0.1_amd64.deb  ...
...
```
kos@kos-pc:~/Yan_debug/0729_release$ ls -ll /etc/ld.so.conf.d/rpp_Kylin.conf 
...
```
kos@kos-pc:~/Yan_debug/0729_release$  ls -ll /usr/include/xpu/rpp/ | head
总用量 1268
-rw-r--r-- 1 root root  16213 6月   6 22:37 bfloat16.h
-rw-r--r-- 1 root root   7086 6月   6 22:37 __clang_cuda_builtin_vars.h
-rw-r--r-- 1 root root   3372 7月  22 15:09 common.h
-rw-r--r-- 1 root root   3150 6月   6 22:37 cuda2rpp.h
-rw-r--r-- 1 root root  17620 7月  22 15:09 drvapi_error_string.h
-rw-r--r-- 1 root root   1794 7月  22 15:09 fifo_mutex.h
-rw-r--r-- 1 root root   3467 7月  22 15:09 gdev_list.h
-rw-r--r-- 1 root root 146237 6月   6 22:37 half.hpp
-rw-r--r-- 1 root root   1489 7月  22 15:09 msg_def.h
kos@kos-pc:~/Yan_debug/0729_release$ 
```
...
```
kos@kos-pc:~/Yan_debug/0729_release$  ls -ll /usr/lib/xpu/rpp/
总用量 4164
lrwxrwxrwx 1 root root      16 7月  29 15:42 librpp_perf.so -> librpp_perf.so.1
lrwxrwxrwx 1 root root      20 7月  29 15:42 librpp_perf.so.1 -> librpp_perf.so.1.0.0
-rw-r--r-- 1 root root   61728 7月  29 15:42 librpp_perf.so.1.0.0
lrwxrwxrwx 1 root root      12 7月  29 15:45 liburpp.so -> liburpp.so.2
lrwxrwxrwx 1 root root      19 7月  29 15:45 liburpp.so.2 -> liburpp.so.2.0.21.5
-rw-r--r-- 1 root root 4198336 7月  29 15:45 liburpp.so.2.0.21.5
kos@kos-pc:~/Yan_debug/0729_release$ 
```
...
```
kos@kos-pc:~/Yan_debug/0729_release$ sudo dpkg --purge xdl-rpp-dkms
(正在读取数据库 ... 系统当前共安装有 259222 个文件和目录。)
正在卸载 xdl-rpp-dkms (1.0.0) ...

-------- Uninstall Beginning --------
Module:  rpp-dkms
Version: 2.0.16.12
Kernel:  5.4.18-152-generic (x86_64)
-------------------------------------
...
rpp.ko:
 - Uninstallation
   - Deleting from: /lib/modules/5.4.18-152-generic/kernel/extra/
 - Original module
...
------------------------------
Deleting module version: 2.0.16.12
completely from the DKMS tree.
------------------------------
Done.
正在清除 xdl-rpp-dkms (1.0.0) 的配置文件 ...
kos@kos-pc:~/Yan_debug/0729_release$ 
```
...
```
kos@kos-pc:~/Yan_debug/0729_release$  ls -ll /usr/src/rpp-dkms-*/ |head
ls: 无法访问'/usr/src/rpp-dkms-*/': 没有那个文件或目录
kos@kos-pc:~/Yan_debug/0729_release$  ls -ll /lib/modules/$(uname -r)/kernel/extra/
ls: 无法访问'/lib/modules/5.4.18-152-generic/kernel/extra/': 没有那个文件或目录
kos@kos-pc:~/Yan_debug/0729_release$ 
```
...
```bash
kos@kos-pc:~/Yan_debug/0729_release$ sudo dpkg --purge xdl-rpp-runtime 
(正在读取数据库 ... 系统当前共安装有 259168 个文件和目录。)
正在卸载 xdl-rpp-runtime (1.0.1) ...
kos@kos-pc:~/Yan_debug/0729_release$ 
```
