...
// DTK ( Hygon ROCm-compatible toolkit) uses gfx928 which is a CDNA2-based architecture.
// Without this mapping, kernels optimized for CDNA2 (e.g. MFMA instructions) would not
// be enabled on gfx928 GPUs, leading to performance degradation.
#if defined(__gfx928__)
#define CDNA2
#endif // defined(__gfx928__)
