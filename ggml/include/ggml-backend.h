...
extern "C" {
    ...
    enum ggml_backend_dev_type {
        ...
        // hardware accelerator visible to --list-devices but not auto-initialized for compute
        GGML_BACKEND_DEVICE_TYPE_HM_ACCEL,
    ...
    // Unload all dynamically loaded backends and rebuild device list from static backends
    GGML_API void               ggml_backend_unload_all(void);
